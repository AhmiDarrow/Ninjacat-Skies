# Ninjacat Skies Core 0.5.12

**Your things wait in a basket, Thread comes in skeins and bolts, and Steward Caches are worth opening.** Existing saves load as they are; no ids change. This replaces 0.5.8 to 0.5.11, which never shipped in a pack.
