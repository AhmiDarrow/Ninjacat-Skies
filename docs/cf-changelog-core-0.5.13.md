# Ninjacat Skies Core 0.5.13

**Your things wait in a basket, Thread comes in skeins and bolts, and Steward Caches are worth opening.** Existing saves load as they are; no ids change. This replaces 0.5.8 to 0.5.12, which never shipped in a pack.

**The Codex on Tribal Power 5.0**

- Six new entries in the Nine Tribes section: **Elders that talk**, **Guardians of the March** (and the Ninth Agreement), **The living March**, **The table and the kettle**, **Spirit arms**, and **Every hand wants a voice** — which kept Resonance Totem each automated device needs since Tribal Power 5.0. Three tribe pages are corrected for Elders that give work and stories.

**Ready to translate**

- **Every line a player reads is in a lang file now**: chat and action-bar messages, tooltips, boss bars, the hub signs and books, and the whole Whisker Codex (about 1,500 keys across the six mods). The English is unchanged. If you would like the pack in your language, the files are on GitHub and translations are welcome.

**A Dismount key**

- **Sneak no longer gets you off what you ride.** It was doing two jobs at once: steering your mount (a chocobo descends on sneak) and throwing you out of the saddle. Now sneak only steers.
- **Press Dismount to get off** — **Caps Lock** by default, under Ninjacat Skies in Controls. It works for everything you ride: chocobos, horses, boats, minecarts.
- A chocobo still will not drop you in mid-air or onto water, and a race still holds you in the saddle.
- Server owners who want the old behaviour back can set `controls.sneakDismounts = true` in `ninjacatskies-common.toml`.
