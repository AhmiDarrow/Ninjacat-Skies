...
class StewardCaches(unittest.TestCase):
    ...
    def test_existing_save_ids_preserved(self):
        ...
        # +50: Tribal Power 5.0 (late block 0x8046-0x8077 of the Tribal Weave chapter).
        self.assertEqual(len(self.rows), 1701)
    ...
    def test_distribution_preserves_threads_and_excludes_repeatable_shop(self):
        ...
        self.assertEqual(threads, 1587)   # +1: the End Apple quest, which takes no cache; +50: Tribal Power 5.0, no caches either
