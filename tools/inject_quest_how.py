...
HOW_ITEM = {
    ...
    "minecraft:netherrack": "How: the Nether here is void, not terrain. Pour lava into an Ex Deorum barrel of witch water (a water barrel standing on mycelium; mycelium spores sieve from dirt).",
    "minecraft:soul_sand": "How: sand into an Ex Deorum barrel of witch water. Fortress wart rooms hold a little. Three skulls on soul sand make a Wither.",
    "minecraft:glowstone_dust": "How: sieve soul sand, or witches on the pad.",
    ...
    "minecraft:magma_cream": "How: a slime ball dropped into a lava barrel, slime plus blaze powder, or magma cubes.",
    ...
    "minecraft:comparator": "How: nether quartz, redstone torch, stone. Quartz sieves from soul sand; no Nether trip needed.",
    ...
    "minecraft:crying_obsidian": "How: bastion chests, piglin barter, or Draconic bees working obsidian. Ruined portals do not generate here.",
    ...
    "minecraft:quartz": "How: sieve soul sand, or piglin barter.",
    "minecraft:netherite_ingot": "How: four scrap plus four gold. Debris is rare Nether after Claw.",
    "minecraft:ancient_debris": "How: hammer blackstone to crushed blackstone and sieve it. Bastion chests hold a little.",
    ...
    "minecraft:nether_gold_ore": "How: Mekanism Combiner, eight raw gold plus netherrack. The void Nether has no ore.",
    ...
    "minecraft:blackstone": "How: witch water poured into a lava barrel, or four blackstone pebbles. Bastions are built of it.",
    "minecraft:basalt": "How: lava flowing over soul soil beside blue ice, or four basalt pebbles from sieved crushed blackstone.",
    "minecraft:glowstone": "How: four glowstone dust. Dust sieves from soul sand.",
    "minecraft:soul_soil": "How: soul sand dropped into an Ex Deorum lava barrel.",
    ...
    "minecraft:polished_basalt": "How: stonecutter, or four basalt.",
    "minecraft:smooth_basalt": "How: smelt basalt.",
    "minecraft:magma_block": "How: four magma cream. A slime ball in a lava barrel makes cream.",
    "minecraft:shroomlight": "How: grows on huge fungi. Plant a fungus on nylium and bone-meal it.",
    "minecraft:nether_wart_block": "How: nine nether wart. Wart sieves from soul sand or grows in fortress gardens.",
    "minecraft:warped_wart_block": "How: grows on huge warped fungi. Bone-meal a warped fungus on warped nylium.",
    "minecraft:crimson_stem": "How: crimson nylium spores (sieve crushed netherrack) on netherrack, bone-meal the nylium for a fungus, then bone-meal the fungus.",
    "minecraft:warped_stem": "How: warped nylium spores (sieve crushed netherrack) on netherrack, bone-meal the nylium for a fungus, then bone-meal the fungus.",
    ...
    "minecraft:nether_star": "How: Wither (three skulls on soul sand), or the Spark stall at /clowder hub once, for 12 Thread Bolts (972 Thread). Optional trophy — it does not gate End or Mob Farm 100%.",
    ...
    "minecraft:shulker_box": "How: the Spark stall at /clowder hub sells one for 22 Thread Skeins (198 Thread); shells never drop here. Optional.",
