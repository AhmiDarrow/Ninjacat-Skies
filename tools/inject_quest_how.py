...
HOW_ITEM = {
    ...
    "minecraft:dirt": "How: starter chest, cobble+thread sink, sieve leftovers, or Dock Kin (Pad-keepers stall).",
    "minecraft:crafting_table": "How: four planks in a square.",
    "minecraft:wooden_pickaxe": "How: three planks over two sticks.",
    "minecraft:oak_sapling": "How: break oak leaves, or Pad-keepers stall (8 Thread).",
    ...
    "minecraft:torch": "How: coal or charcoal over a stick. Dock Kin sell a pack.",
    "minecraft:cobblestone": "How: lava next to water (or ice melt). Hammer stone. Dock Grit stall sells a bundle.",
    "minecraft:furnace": "How: eight cobble around an empty centre.",
    "minecraft:bread": "How: three wheat in a row, or Pad-keepers stall.",
    "minecraft:bucket": "How: three iron ingots, or Pad-keepers stall (8 Thread). Fill from melted ice.",
    "minecraft:water_bucket": "How: empty bucket on a water source. Normal/Hard: place lava, melt ice, fill.",
    "minecraft:leather": "How: smelt or campfire rotten flesh. Sieve dirt with flint mesh. Pad-keepers stall sells two for 18 Thread.",
    ...
    "minecraft:bone": "How: skeletons at night, or Pad-keepers stall (16 Thread for 8).",
    "minecraft:bone_meal": "How: bones in a grid, or Thread + rotten flesh sink, or Pad-keepers stall.",
    "minecraft:slime_ball": "How: two dirt + wheat seeds + bone meal (pad compost), or Pad-keepers stall.",
    "minecraft:ender_pearl": "How: endermen, or Dock Spark stall.",
    ...
    "tribalpower:bone_chime": "How: one bone, string, amethyst. Pad-keepers stall sells bones. Spark / Hum gate.",
