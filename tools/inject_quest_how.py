...
HOW_ITEM = {
    ...
    "minecraft:nether_star": "How: Wither (three skulls on soul sand), or the Spark stall at /clowder hub once, for 1000 Thread. Optional trophy — it does not gate End or Mob Farm 100%.",
    ...
    "minecraft:shulker_box": "How: the Spark stall at /clowder hub sells one for 200 Thread; shells never drop here. Optional.",
